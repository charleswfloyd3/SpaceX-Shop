         ...
         <div className="featured-products">
            ...
            <div className="featured-outer">
                <div className="featured-product1" >
                    <img src="https://cdn.shopify.com/s/files/1/0261/2615/5855/products/Crew-2_missionpatch_UPDATEDcopy_900x.png?v=1636404445" className="featured-img1" onClick={()=>{setProductEvent(featuredproductsobj[0]);window.scrollTo(0, 0)}}></img>
                ...
                <div className="featured-product2" onClick={()=>{setProductEvent(featuredproductsobj[1]);window.scrollTo(0, 0)}}>
                    <img src="https://cdn.shopify.com/s/files/1/0261/2615/5855/products/KIDS-11-SPACEDUIT-ONESIE-INFANT-ONESIE-WHITE-GREY-FRONT_900x.png?v=1631644234" className="featured-img2"></img>
